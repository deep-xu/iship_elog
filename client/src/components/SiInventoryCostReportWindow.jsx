...
export default function SiInventoryCostReportWindow({ onMinimize, onClose, preview = false }) {
  return (
    <ReportOptionWindow title="SI Inventory Cost" onMinimize={onMinimize} onClose={onClose} preview={preview}>
