        ...
        <section className="flex flex-1 items-center justify-end px-[clamp(24px,9vw,170px)] py-12">
          <div className="w-full max-w-[540px] border border-white/80 bg-[#eef8f8]/88 p-[clamp(22px,3vw,42px)] shadow-[0_24px_70px_rgba(18,64,73,0.26)] backdrop-blur-md">
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="mx-auto mt-4 flex min-w-[166px] items-center justify-center bg-ns-navy px-8 py-3 text-[16px] font-semibold text-white transition-colors hover:bg-ns-navy-dark focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#eaf6f7]"
              >
                Login
              </button>
            </form>
