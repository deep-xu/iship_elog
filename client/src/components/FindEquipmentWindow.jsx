import EquipmentExplorer from './EquipmentExplorer.jsx'

export default function FindEquipmentWindow(props) {
  return <EquipmentExplorer {...props} initialMode="equipment" />
}

function ToolButton({ label, children, muted = false }) {
  return (
    <button
      type="button"
      title={label}
...
function Sep() {
  return <span className="h-[22px] w-px shrink-0 bg-neutral-300" />
}
