export default function WorkOrderWizardWindow({ onMinimize, onClose, preview = false }) {
  return (
    <div className="flex h-full w-full flex-col overflow-hidden border border-[#dce8ef] bg-[#f7fbfd] shadow-[0_24px_60px_rgba(68,101,129,0.14)]">
      <div className="flex h-[34px] shrink-0 items-center bg-[#f7fbfd] pl-[10px]">
        ...
        <span className="ml-[9px] text-[17px] font-semibold text-ns-navy">Work Order Wizard</span>
      ...
      <div className="min-h-0 flex-1 overflow-auto bg-white p-[10px]">
        <div className="flex min-h-full flex-col border border-[#e4edf3] bg-white">
          <div className="px-[18px] pb-[10px] pt-[34px] text-[26px] font-semibold text-ns-navy">
            Welcome to the Work Order Wizard
          </div>

          <div className="flex min-h-0 flex-1 border-t border-[#e4edf3]">
            <div className="flex w-[270px] shrink-0 flex-col bg-[#7d95ad] p-[10px] text-white">
              ...
              <div className="pt-[26px] text-[24px] leading-[1.25]">Work Order Wizard</div>
            </div>

            <div className="min-w-0 flex-1 px-[12px] py-[14px] text-[23px] font-semibold leading-[1.45] text-ns-navy">
              <p>This Wizard will help you to create work orders for multiple vessels simultaneously.</p>
              <p className="pt-[10px]">
                A reference work order can be used to create multiple work orders for the rest of the
                vessels.
              </p>
              <p className="pt-[10px]">
                Note: Once the work orders are created for different vessels they will have their own
                identities.
              </p>
              <p className="pt-[10px]">To get started, click Next.</p>
            </div>
          </div>
