...
export default function EquipmentParticularsReportWindow({ onMinimize, onClose, preview = false }) {
  return (
    <ReportOptionWindow title="Equipment Particulars" onMinimize={onMinimize} onClose={onClose} preview={preview}>
