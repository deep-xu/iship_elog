...
export default function WarrantyExpirationListingReportWindow({ onMinimize, onClose, preview = false }) {
    ...
    <div style={frameStyle}>
      <div style={{ width: '100%', height: '100%', background: '#efefef', border: '1px solid #a7a7a7', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: 20, overflow: 'auto' }}>
          ...
          <div style={{ border: '1px solid #dce8ef', background: '#fff', padding: 24, display: 'grid', gridTemplateColumns: '1fr auto', gap: 16 }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <Radio checked={false} label="Schedule" />
            </div>
            <button
              style={{
                alignSelf: 'end',
