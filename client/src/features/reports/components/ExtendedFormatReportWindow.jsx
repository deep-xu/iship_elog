...
export default function ExtendedFormatReportWindow({ onMinimize, onClose, preview = false }) {
  return (
    <ReportOptionWindow title="Extended Format" onMinimize={onMinimize} onClose={onClose} preview={preview}>
